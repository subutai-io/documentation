...
The peers satisfying these governance rules (criteria) are authorized to join the swarm. Then as load changes the environment can shift resources based on load and cost.
